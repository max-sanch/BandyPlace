    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=64, unique=True, verbose_name='Уникальное название для URL')),
                ('title', models.CharField(max_length=256, verbose_name='Заголовок новости')),
                ('body', models.TextField(max_length=4096, verbose_name='Основной текст новости')),
